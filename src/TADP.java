...
public class TADP {
    ...
    public static void main(String[] args){
        ...
        List<double[]> list = njnp.sensors(5);
    ...
    void charge(List<double[]> sensors, int time) {     // 0.1 S 一个时间片
        ...
        try {
            FileWriter fw = new FileWriter("D:/My_idea.txt", true);
            BufferedWriter bw = new BufferedWriter(fw);
            bw.append("小车当前位置：(" + car_loc[0] + "," + car_loc[1] + ") , 当前能量利用率：" +
    ...
    void road(double[][] matrix, List<double[]> sensors) {
